      ...
      <div className="bg-gray-900 border border-gray-700 rounded-xl shadow-2xl p-4 mx-4 backdrop-blur-sm">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              onClick={onRefresh}
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:scale-105 active:scale-95"
            >
              Refrescar
            </button>
          </div>
