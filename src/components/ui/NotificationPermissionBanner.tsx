        ...
        <div className="flex items-center justify-between py-3 sm:py-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 ml-3 flex-shrink-0">
            ...
            <button
              onClick={handleAllow}
              disabled={isLoading}
              className="bg-white text-blue-600 hover:bg-blue-50 disabled:bg-white/90 disabled:cursor-not-allowed px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-sm sm:text-base transition-all duration-200 transform hover:scale-105 disabled:hover:scale-100 shadow-lg"
            >
              {isLoading ? (
