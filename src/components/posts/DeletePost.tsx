...
const DeletePost: FC<DeletePostProps> = ({ postId, postTitle, onDelete, isOpen, onClose, onSuccess }) => {
        ...
        <div className="p-6">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-white">Eliminar Post</h3>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              disabled={isDeleting}
              className="flex-1 bg-red-600 hover:bg-red-700 disabled:bg-red-800 disabled:cursor-not-allowed text-white py-2.5 rounded-lg font-medium transition-colors duration-200"
            >
              {isDeleting ? (
