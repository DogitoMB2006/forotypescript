          ...
          {index < posts.length - 1 && (
            <div className="flex items-center justify-center my-8">
              <div className="flex items-center space-x-4 w-full max-w-md">
                <div className="h-px bg-gradient-to-r from-transparent via-gray-700 to-gray-700 flex-1"></div>
                <div className="w-2 h-2 bg-gray-700 rounded-full"></div>
                <div className="h-px bg-gradient-to-l from-transparent via-gray-700 to-gray-700 flex-1"></div>
              </div>
            </div>
          )}
        </div>
